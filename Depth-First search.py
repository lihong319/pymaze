...
a=agent(m,12,12,footprints=True,shape='square',color=COLOR.green)              
b=agent(m,1,1,goal=(12,12),footprints=True,filled=True,color=COLOR.cyan)      
c=agent(m,12,12,footprints=True,color=COLOR.yellow)                          
